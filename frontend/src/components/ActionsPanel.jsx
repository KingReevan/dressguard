...
export default function ActionsPanel({ onShowHistory }){
    return(
        <div className="bg-green-950 border border-green-500 p-2 sm:p-3 md:p-4 rounded flex flex-col gap-2 sm:gap-3 h-full overflow-y-auto">
          ...
          <button className="bg-black border border-green-600 py-1 sm:py-2 hover:bg-green-900 transition text-xs sm:text-sm" onClick={onShowHistory}>
            History
          </button>
        </div>
    );
